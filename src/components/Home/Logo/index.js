...
import { MotionPathPlugin } from 'gsap-trial/MotionPathPlugin'; // Import MotionPathPlugin
    ...
    useEffect(() => {
        ...
        gsap
          ...
          .from(outlineLogoRef.current, {
              duration: 20,
              motionPath: { // Use MotionPathPlugin for the animation
                  path: [{ x: 0, y: 0 }, { x: 100, y: -100 }, { x: 200, y: 0 }], // Define the path
                  curviness: 1.5, // Adjust curvature as needed
